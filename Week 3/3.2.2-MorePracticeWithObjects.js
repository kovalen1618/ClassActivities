...
const diverseObj = {
  ...
  numKey: 42,
  boolKey: false,
  collection: ["I am another string", 24, true]
};

// Access a value in the "collection" property
console.log(diverseObj.collection[2]);

// Practice with nested Arrays and Objects
const keys = ["key", "1", "method", "favorites", "list"];

// Add a method to an Object
obj.method = function addMethod() {
...
// Will print 5 times printing the name of the key and its value
for (let key in keys) {
  console.log(`Key is: ${key} and value is: ${obj[key]}`);
}

// Use a template literal to print a sentence about your favorite things
for (let thing in obj.favorites) {
  console.log(`My favorite ${thing} is ${obj.favorites[thing]}`);
}
